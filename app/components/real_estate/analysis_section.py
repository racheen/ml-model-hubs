...
from app.domain.real_estate.config import CATEGORY, DEFAULT_MODELS, USE_JOBLIB, EXPECTED_FEATURES

def render_analysis_section():
    render_section_title("Model Analysis", "Inspect saved model files and any exposed coefficients or feature importances.")
    model_name = st.selectbox("Model to analyze", DEFAULT_MODELS, key="real_estate_analysis_model")
